...
$(document).ready(function () {
  $(".testimonial_slider").slick({
    ...
    speed: 1000,
    prevArrow:
      '<button type="button" class="slick-prev"><img src="/static/myapp/assets/images/slider-right-arrow.png" alt="slider-right-arrow"></button>',
    nextArrow:
      '<button type="button" class="slick-next"><img src="/static/myapp/assets/images/slider-left-arrow.png" alt="slider-left-arrow"></button>',
    responsive: [
      {
        breakpoint: 991,
        settings: {
...
let cursorScale = document.querySelectorAll(
  "a,button,.nested-accordion,.trigger,.html-popup,.youtube,#vimeo,.link,.new-img-box-main,.cursor-pointer,.cursor-arrow,.play-button,.cf_image"
);
let mouseX = 0;
let mouseY = 0;
...
$(document).ready(function () {
  $(".services-gallery-main").slick({
    ...
    speed: 1600,
    prevArrow:
      '<button type="button" class="services-gallery-main-prev"><img src="assets/images/slider-right-arrow.svg" alt="slider-right-arrow"></button>',
    nextArrow:
      '<button type="button" class="services-gallery-main-next"><img src="assets/images/slider-left-arrow.svg" alt="slider-left-arrow"></button>',
  });
});
